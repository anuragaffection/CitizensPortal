...
public class PageLogin extends AppCompatActivity {
    ...
    private EditText anuEmail, anuPassword;
    ...
    protected void onCreate(Bundle savedInstanceState)
    {
        ...
        anuEmail = findViewById(R.id.anuEmail);
        anuPassword = findViewById(R.id.anuPassword);
    ...
    private void loginUserAccount()
    {
        ...
        email = anuEmail.getText().toString();
        password = anuPassword.getText().toString();
